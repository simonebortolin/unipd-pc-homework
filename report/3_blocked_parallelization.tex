    ...
    \begin{minipage}{\textwidth}
        \begin{algorithm}[H]
            ...
            \Pn{\FFloydBlocked{\(W\)}}{
                ...
                \For{\(h \in [1:n \operatorname{with} \operatorname{step} b]\)}{
                    \FFloyd(\(d[h:h+b,h:h+b],d[h:h+b,h:h+b],d[h:h+b,h:h+b],pred[h:h+b,h:h+b]\)) \label{alg:block-diagonal}

                    \For{\(j  \in [1:n \operatorname{with} \operatorname{step} b] \setminus h\)} {
                        \FFloyd(\(d[h:h+b,j:j+b],d[h:h+b,h:h+b],d[h:h+b,j:j+b],pred[h:h+b,h:h+b]\)) \label{alg:block-row}
                    }

                    \For{\(i  \in [1:n \operatorname{with} \operatorname{step} b]  \setminus h\)} {
                        \FFloyd(\(d[i:i+b,h:h+b],d[i:i+b,h:h+b],d[h:h+b,h:h+b],pred[h:h+b,h:h+b]\)) \label{alg:block-column}

                        \For{\(j  \in [1:n \operatorname{with} \operatorname{step} b] \setminus h\)} {
                            \FFloyd(\(d[i:i+b,j:j+b],d[i:i+b,h:h+b],d[h:h+b,j:j+b],pred[h:h+b,h:h+b]\)) \label{alg:block-other}
                        }
                    }
                }
            }
