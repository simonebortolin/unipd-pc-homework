        ...
        \begin{algorithm}[H] \label{alg:Floyd}
            ...
            \Pn{\FFloydBlocked{\(d\)}}{
                ...
                \For{\(h \in [1{\twodots}n \operatorname{with} \operatorname{step} s]\)}{
                    \FFloyd{\(d[h{\twodots}h{+}s,h{\twodots}h{+}s],d[h{\twodots}h{+}s,h{\twodots}h{+}s],d[h{\twodots}h{+}s,h{\twodots}h{+}s],pred[h{\twodots}h{+}s,j{\twodots}j{+}s]\)} \label{alg:block-diagonal}

                    \For{\(j  \in [1{\twodots}n \operatorname{with} \operatorname{step} s] \setminus h\)} {
                        \FFloyd{\(d[h{\twodots}h{+}s,j{\twodots}j{+}s],d[h{\twodots}h{+}s,h{\twodots}h{+}s],d[h{\twodots}h{+}s,j{\twodots}j{+}s],pred[i{\twodots}i{+}s,h{\twodots}h{+}s]\)} \label{alg:block-row}
                    }

                    \For{\(i  \in [1{\twodots}n \operatorname{with} \operatorname{step} s]  \setminus h\)} {
                        \FFloyd{\(d[i{\twodots}i{+}s,h{\twodots}h{+}s],d[i{\twodots}i{+}s,h{\twodots}h{+}s],d[h{\twodots}h{+}s,h{\twodots}h{+}s],pred[h{\twodots}h{+}s,h{\twodots}h{+}s]\)} \label{alg:block-column}

                        \For{\(j  \in [1{\twodots}n \operatorname{with} \operatorname{step} s] \setminus h\)} {
                            \FFloyd{\(d[i{\twodots}i{+}s,j{\twodots}j{+}s],d[i{\twodots}i{+}s,h{\twodots}h{+}s],d[h{\twodots}h{+}s,j{\twodots}j{+}s],pred[i{\twodots}i{+}s,j{\twodots}j{+}s]\)} \label{alg:block-other}
                        }
                    }
                }
            }
